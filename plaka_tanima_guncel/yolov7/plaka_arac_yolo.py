...
credentialData = credentials.Certificate("veri_tabani/evident-league-351311-firebase-adminsdk-cxb2a-5740ffc51d.json")

firebase_admin.initialize_app(credentialData, {
'storageBucket': 'evident-league-351311.appspot.com'
})
...
def yetkili_arac(plaka,source):
    ...
    belge_kimligi =  ay+" "+ gun+" "+saat+" "+dakika # Kendi belge kimliğinizi burada belirleyin
    belge_verileri = {
        
        'plaka': plaka,
        'dosya_adi': source,
        'islem_gorevi': islem_gorevi,
        'islem_ay': ay,
        'islem_gun': gun,
        'islem_saat': saat,
        'islem_dakika': dakika,
    ...
    try:
        firestoreDb.collection(u'yetkili_arac_islem_tablo').document(belge_kimligi).set(belge_verileri)
    except:
        pass
...
def yetkili_kullanici(plaka,source):
    ...
    try:
        firestoreDb.collection(u'yetkili_kullanici_islem_tablo').document(belge_kimligi).set(belge_verileri)
...
def gunluk_islem(plaka,source):
    ...
    belge_verileri = {
        ...
        'islem_saat': saat,
        'islem_dakika': dakika,
        'plaka_tespit_edilme': tespit_edilme
    }
    try:
        firestoreDb.collection(u'gunluk_islem_tablo').document(belge_kimligi).set(belge_verileri)
    except:
        pass
...
def yetkisiz_arac(plaka,source):
    ...
    belge_verileri = {
        ...
        'islem_saat': saat,
        'islem_dakika': dakika,
        'plaka_tespit_edilme': 'Plaka Var'
    }

    try:
        firestoreDb.collection(u'yetkisiz_islem_tablo').document(belge_kimligi).set(belge_verileri)
    except:
        pass
...
def veri_tabani(plaka,source):
    ...
    try:
        upload_image(source, source)
        pass
    except:
        print("Hataaaaaaaaaaaa Firebase")
