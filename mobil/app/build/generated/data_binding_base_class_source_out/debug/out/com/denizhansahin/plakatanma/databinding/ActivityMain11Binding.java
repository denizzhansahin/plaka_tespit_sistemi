...
public final class ActivityMain11Binding implements ViewBinding {
  ...
  @NonNull
  public final EditText plakaOzel;

  @NonNull
  public final Button plakaOzelButton;
  ...
  private ActivityMain11Binding(@NonNull ConstraintLayout rootView, @NonNull TextView kullaniciID,
      @NonNull TextView kullaniciID1, @NonNull EditText plakaOzel, @NonNull Button plakaOzelButton,
      @NonNull TextView plakaTespitEdilme, @NonNull TextView plakaTespitEdilme1,
      @NonNull ScrollView scrollView5, @NonNull TableLayout tableLayout,
      @NonNull TableLayout tableLayout1, @NonNull TextView textViewDosyaAdi,
      @NonNull TextView textViewDosyaAdi1, @NonNull TextView textViewIslemAy,
      @NonNull TextView textViewIslemAy1, @NonNull TextView textViewIslemDakika,
      @NonNull TextView textViewIslemDakika1, @NonNull TextView textViewIslemGorevi,
      @NonNull TextView textViewIslemGorevi1, @NonNull TextView textViewIslemGun,
      @NonNull TextView textViewIslemGun1, @NonNull TextView textViewIslemSaat,
      @NonNull TextView textViewIslemSaat1) {
    this.rootView = rootView;
    this.kullaniciID = kullaniciID;
    this.kullaniciID1 = kullaniciID1;
    this.plakaOzel = plakaOzel;
    this.plakaOzelButton = plakaOzelButton;
  ...
  public static ActivityMain11Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.plaka_ozel;
      EditText plakaOzel = ViewBindings.findChildViewById(rootView, id);
      if (plakaOzel == null) {
        break missingId;
      }

      id = R.id.plaka_ozel_button;
      Button plakaOzelButton = ViewBindings.findChildViewById(rootView, id);
      if (plakaOzelButton == null) {
        break missingId;
      }
      ...
      return new ActivityMain11Binding((ConstraintLayout) rootView, kullaniciID, kullaniciID1,
          plakaOzel, plakaOzelButton, plakaTespitEdilme, plakaTespitEdilme1, scrollView5,
