...
public final class ActivityMain10Binding implements ViewBinding {
  ...
  private ActivityMain10Binding(@NonNull ConstraintLayout rootView, @NonNull EditText ayOzel,
  ...
  public static ActivityMain10Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain10Binding((ConstraintLayout) rootView, ayOzel, gunAyButton, gunOzel,
