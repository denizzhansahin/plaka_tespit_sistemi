...
public final class ActivityMain7Binding implements ViewBinding {
  ...
  @NonNull
  public final TextView textViewPlakaTespit;

  @NonNull
  public final TextView textViewPlakaTespit1;

  private ActivityMain7Binding(@NonNull ConstraintLayout rootView, @NonNull ScrollView scrollView5,
      ...
      @NonNull TextView textViewPlakaTespit, @NonNull TextView textViewPlakaTespit1) {
    ...
    this.textViewPlakaTespit = textViewPlakaTespit;
    this.textViewPlakaTespit1 = textViewPlakaTespit1;
  }
  ...
  public static ActivityMain7Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewPlakaTespit;
      TextView textViewPlakaTespit = ViewBindings.findChildViewById(rootView, id);
      if (textViewPlakaTespit == null) {
        break missingId;
      }

      id = R.id.textViewPlakaTespit1;
      TextView textViewPlakaTespit1 = ViewBindings.findChildViewById(rootView, id);
      if (textViewPlakaTespit1 == null) {
        break missingId;
      }

      return new ActivityMain7Binding((ConstraintLayout) rootView, scrollView5, tableLayout,
          ...
          textViewPlaka1, textViewPlakaTespit, textViewPlakaTespit1);
    }
