...
public final class ActivityMain4Binding implements ViewBinding {
  ...
  private ActivityMain4Binding(@NonNull ConstraintLayout rootView, @NonNull ScrollView scrollView5,
  ...
  public static ActivityMain4Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain4Binding((ConstraintLayout) rootView, scrollView5, tableLayout,
